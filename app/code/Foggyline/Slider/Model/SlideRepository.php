...
class SlideRepository implements \Foggyline\Slider\Api\SlideRepositoryInterface {
  ...
  /**
   * Retrieve the slide matching the specified critera
   *
   * @param \Magento\Framework\Api\SearchCriteriaInterface $searchCriteria
   * @return \Magento\Framework\Api\SearchResultsInterface
   * @throws \Magento\Framework\Exception\LocalizedException
   */
  public function getList(\Magento\Framework\Api\SearchResultsInterface $searchCriteria) {
